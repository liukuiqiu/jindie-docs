...
![8.2.7.1](/assets/media/8.2.7.1.png)
...
![流程设置](/assets/media/manual-financial-8.5-1.png)

以签单审核规则为例：

Step1：进入“流程设置->签单审核规则”。
![流程设置](/assets/media/manual-financial-8.5-2.png)
Step2：点击编辑图标修改审核节点名称，如：签单审批③。
![流程设置](/assets/media/manual-financial-8.5-3.png)
Step3：点击“请选择审核角色”，指定角色。
![流程设置](/assets/media/manual-financial-8.5-4.png)
Step4：开启审核节点，该角色就可以在“签单审核”列表审核签单啦~
![流程设置](/assets/media/manual-financial-8.5-5.png)
